...
const discount_savings = (sorted_items, items_and_prices, special_offers) => {
  ...
  for(const offer in special_offers){
    ...
    console.log(`offer object = ${offer_item}`)
    console.log(`offer_item_count = ${offer_item_count}`)
    console.log(`required for offer = ${offer_required_quantity}`)
    // const number_of_times_offer_applies = offer_item_count / offer_required_quantity
